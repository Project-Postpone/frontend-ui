      ...
      <div className="bg-blue-200 rounded-2xl flex max-w-3xl p-5 items-center">
        <div className="md:w-1/2 px-8">
          ...
          <div className="mt-4 text-sm flex justify-between items-center">
            ...
            <button
              className="hover:border text-white bg-blue-400 hover:border-white rounded-xl py-2 px-5 hover:scale-110 hover:bg-blue-300 font-semibold duration-300 animate-bounce"
