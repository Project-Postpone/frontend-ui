                        ...
                        <div className="relative flex h-16 items-center justify-between lg:border-b lg:border-sky-800">
                            <div className="flex items-center px-2 lg:px-0">
                                ...
                                <div className="hidden lg:ml-6 lg:block lg:space-x-4">
                                    <div className="flex">
                                        <a href="/landingpage" className="bg-blue-700 bg-opacity-25 rounded-md py-2 px-3 text-sm font-medium text-white">Postpone</a>
                                        <a href="#" className="hover:bg-blue-700 rounded-md py-2 px-3 text-sm font-medium text-white">Write a letter</a>
